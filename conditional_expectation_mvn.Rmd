...
All homework assignments involving R in this course should be done using RMarkdown. Proofs can be handwritten or typed in LaTeX, preferably. You need to upload your final solution in PDF format. Uploading different file formats will result in a zero score.
